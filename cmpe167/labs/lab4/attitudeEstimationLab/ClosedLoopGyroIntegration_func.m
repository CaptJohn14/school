...
q=deg2rad(0);
r=deg2rad(0);
gyroInput=[p;q;r];      %gyro input

biasTerms=[.1;.1;.1];
% biasTerms=[.0;.0;.0];

accelInertial=[0;0;-1]; % copy
accelReading=[0;0;-1];  % accel raw. don't divide 16000

magInertial=[1;0;0];    % copy
magReading=[1;0;0];     % copy
...
biasEstimate=[0;0;0];   % will get this
nvector=[1;0;0];
evector=[0;-1;0];
dvector=[0;0;-1];
