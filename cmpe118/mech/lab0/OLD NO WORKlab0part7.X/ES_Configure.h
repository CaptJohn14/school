...
// CheckLightDetection
//DisplayBatteryVoltage, CheckLightDetection, bumperHit
...
#define TIMER1_RESP_FUNC PostLightService
...
// the name of the Init function
#define SERV_2_INIT InitLightService
// the name of the run function
#define SERV_2_RUN RunLightService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public fuction prototypes
#define SERV_3_HEADER "TemplateFSM.h"
// the name of the Init function
#define SERV_3_INIT InitTemplateFSM
// the name of the run function
#define SERV_3_RUN RunTemplateFSM
// How big should this services Queue be?
