...
//#define POSTFUNCTION_FOR_KEYBOARD_INPUT PostGenericServic


#define TURN_TICK 220
...
#define DANCE_TICK 4000 //lower for testing.
...
#define EVENT_CHECK_LIST  TemplateCheckBattery, CheckLightDetection
