    ...
    switch (CurrentState) {
        ...
        case FORWARD: // in the first state, replace this with correct names
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    Motors_SetBoth_Print(1000);
//                    Motors_SetRight(100);
//                    Motors_SetLeft(100);
                    break;
                case BUMPER_PRESS:
                    nextState = NO_TAPE_OBSTACLE;
                    makeTransition = TRUE;
        ...
        case NO_TAPE_OBSTACLE: // in the first state, replace this with correct names
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    Motors_SetBoth(0);
                    nextState = ONE_EIGHTY_TURN;
                    makeTransition = TRUE;
                    ThisEvent.EventParam = ES_NO_EVENT;
                    break;
                case ES_EXIT:
        ...
        case ONE_EIGHTY_TURN: // in the first state, replace this with correct names
            switch (ThisEvent.EventType) {
                case ES_TIMEOUT:
