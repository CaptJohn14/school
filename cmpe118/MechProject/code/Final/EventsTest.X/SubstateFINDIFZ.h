...
#ifndef SUB_Substate_FINDIFZ_H  // <- This should be changed to your own guard on both
#define SUB_Substate_FINDIFZ_H  //    of these lines
 ...
 * PUBLIC #DEFINES                                                             *
 ******************************************************************************/
char leftturnfirst = 0;
char rightturnfirst = 0;
char obstacleflag = 0; 
