...
int Motors_SetShooter(int value) {
    if ((value < 0) || (value > MOTOR_MAX_SPEED)) {
        printf("\r\n Shooter motor value error!");
        return MOTOR_ERROR;
    }
...
int Motors_StartShooter(int value) {
    int z;
    //    for (z = 70; z<value; z-=5){
...
int main(void) {
    ...
    //    Motors_SetBoth(50);
    //    Motors_StartShooter(400); 
    Motors_SetShooter(40);
    Servo_Shoot();
    while (1) {
