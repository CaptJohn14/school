...
ES_Event RunSubstateINIFZ(ES_Event ThisEvent) {
    ...
    switch (CurrentState) {
        ...
        case ROTATING: // in the first state, replace this with correct names
            ...
            break;
        case READYTOFIRE: // in the first state, replace this with correct names
            nextState = FIRING;
            ES_Timer_InitTimer(INIFZ_TIMER, 500);
            makeTransition = TRUE;
