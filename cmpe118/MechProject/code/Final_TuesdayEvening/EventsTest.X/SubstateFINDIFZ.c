...
#define HALFFIELD_TICKS 2600
#define FORTYFIVETURN_TICKS 300
#define NINTYTURN_TICKS 650
...
//                nextState = FIND_DIRECTION;
            ...
            break;
        case FIND_DIRECTION: // in the first state, replace this with correct names
