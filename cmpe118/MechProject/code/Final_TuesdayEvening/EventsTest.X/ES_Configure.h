...
#define EVENT_CHECK_LIST  CheckTapeSensors, FindEnemy, CheckBumpers,
...
#define FINDIFZ_TIMER 1
#define FINDIFZ_TIMER2 2
#define INIFZ_TIMER 3
#define TRACKFRB_TIMER 4
#define TRACKFLB_TIMER 5
